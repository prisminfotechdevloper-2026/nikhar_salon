...
export const metadata: Metadata = {
  title: 'Our Story & Founder Firoz Khan | Nikhar Salon Kota',
  description:
    'Discover the legacy of Nikhar Salon in Kota. Meet Founder Firoz Khan with 12+ years mastery in non-surgical hair restoration and precision Italian razor fades.',
  alternates: {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Firoz Khan - Founder Nikhar Salon Kota',
      },
    ],
  },
};
