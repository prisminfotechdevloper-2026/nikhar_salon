...
export default function CraftsmanshipSection() {
  ...
  return (
    <>
      <section className="py-12 sm:py-16 lg:py-20 bg-[#F5F2ED] dark:bg-[#141619] border-b border-[#E5E0D8] dark:border-white/[0.08] relative overflow-hidden transition-colors duration-300">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <h2 className="font-serif-title text-3xl sm:text-4xl lg:text-5xl text-[#181A1C] dark:text-white font-normal leading-tight">
                ...
                <span className="italic text-[#8C734B] dark:text-[#BA9D6A]">A Ritual of Confidence.</span>
              </h2>
              ...
              <div className="space-y-3 pt-2">
                <div className="flex items-center gap-3 text-xs text-[#181A1C] dark:text-white/90">
                  <div className="h-5 w-5 rounded-full bg-[#BA9D6A]/20 border border-[#BA9D6A]/40 flex items-center justify-center text-[#8C734B] dark:text-[#BA9D6A] shrink-0">
                    <Check size={12} />
                  </div>
              ...
              <div className="pt-4">
                <button
                  ...
                  className="inline-flex items-center gap-2.5 gold-gradient text-[#0E1012] font-bold text-xs tracking-wider uppercase px-6 py-3.5 rounded-full shadow-md shadow-[#BA9D6A]/20 hover:scale-105 transition cursor-pointer"
                >
            ...
            <div className="lg:col-span-7">
              <div
                onClick={() => setIsVideoModalOpen(true)}
                className="group relative aspect-[16/10] rounded-2xl md:rounded-3xl overflow-hidden border border-[#E5E0D8] dark:border-[#BA9D6A]/40 shadow-md dark:shadow-[0_20px_50px_rgba(0,0,0,0.6)] cursor-pointer"
              >
                <Image
