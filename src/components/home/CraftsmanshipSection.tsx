    ...
    <div className="space-y-6">
      ...
      <div className="pt-2 flex items-center justify-start sm:justify-between flex-wrap gap-3">
          ...
          {CATEGORIES.map((cat) => {
            ...
            return (
              <button
                ...
                className={`inline-flex items-center gap-2 rounded-lg sm:rounded-xl px-3 sm:px-3.5 py-1.5 text-[11px] font-semibold transition-colors cursor-pointer ${active
                    ? 'bg-[#181A1C] text-white shadow-sm dark:bg-[#BA9D6A] dark:text-[#0E1012] font-bold'
        ...
        <div className="hidden sm:flex items-center gap-2 font-mono text-[10.5px] text-[#7D776D] dark:text-[#A6A29A]">
          ...
          <span>Showing {filteredCount} of {totalCount} Showcase Reels</span>
        </div>
      </div>
    </div>
  );
      ...
      <div className="rounded-2xl border border-[#E5E0D8] bg-white p-4 text-left shadow-md dark:border-white/[0.08] dark:bg-[#141619] sm:p-5 space-y-3.5">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-[#E5E0D8] pb-3 dark:border-white/[0.08]">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <button
              type="button"
              onClick={onOpenModal}
              className="inline-flex items-center gap-1.5 rounded-lg border border-[#D9D4CB] bg-[#FAF8F5] px-2.5 py-1.5 text-[11px] font-semibold text-[#181A1C] hover:border-[#BA9D6A] hover:text-[#8C734B] dark:border-white/15 dark:bg-white/[0.05] dark:text-white dark:hover:text-[#BA9D6A] transition-colors cursor-pointer"
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 rounded-lg border border-[#D9D4CB] bg-[#FAF8F5] px-2.5 py-1.5 text-[11px] font-semibold text-[#181A1C] hover:border-[#BA9D6A] hover:text-[#8C734B] dark:border-white/15 dark:bg-white/[0.05] dark:text-white dark:hover:text-[#BA9D6A] transition-colors"
        ...
        <div className="pt-2 flex flex-wrap items-center justify-between gap-3 border-t border-[#E5E0D8] dark:border-white/[0.08]">
          ...
          <Link
            ...
            className="gold-gradient inline-flex items-center gap-1.5 rounded-full px-4 py-2 text-[11px] font-bold uppercase tracking-wider text-[#0E1012] shadow-xs transition-transform hover:scale-105 active:scale-95 cursor-pointer"
          >
        ...
        {videos.map((video, idx) => {
          ...
          return (
            <div
              ...
              className={`group flex items-center gap-3 rounded-xl p-2.5 text-left transition-[border-color,background-color,box-shadow] duration-300 cursor-pointer ${isActive
