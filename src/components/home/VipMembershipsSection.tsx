            ...
            >
              <div>
                <div className="flex justify-between items-center mb-4">
                  <span className="text-[10px] uppercase tracking-[0.2em] font-bold text-[#8C734B] dark:text-[#BA9D6A] bg-[#BA9D6A]/10 px-2.5 py-1 rounded-full border border-[#BA9D6A]/30">
                    {plan.badge}
                  </span>
                </div>

                <h3 className="font-serif-title text-2xl text-[#181A1C] dark:text-white mb-2">{plan.title}</h3>
                <div className="flex items-baseline gap-1.5 mb-6">
                  <span className="font-serif-title text-3xl sm:text-4xl text-[#8C734B] dark:text-[#BA9D6A] font-medium">
                    {plan.price}
                  </span>
                  <span className="text-xs text-[#7D776D] dark:text-[#A6A29A]">/ {plan.period}</span>
                </div>
