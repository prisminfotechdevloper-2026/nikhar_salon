      ...
      <div className="p-5 sm:p-6 flex flex-col justify-between flex-1 space-y-4">
        ...
        <div className="pt-3 border-t border-[#EAE5DC] dark:border-white/[0.08] flex items-center justify-between">
          ...
          >
            ...
            <div className="h-7 w-7 rounded-full border border-[#E2DDD4] bg-[#FAF8F5] text-[#8C734B] dark:border-white/15 dark:bg-white/[0.05] dark:text-[#BA9D6A] flex items-center justify-center group-hover:border-[#BA9D6A] group-hover:bg-[#BA9D6A]/15 dark:group-hover:bg-[#BA9D6A]/20 transition-all duration-300">
