...
export const CASE_STUDIES: CaseStudy[] = [
  ...
  {
    id: 'case-beard-sculpt',
    title: 'Patchy Jawline to Sharp Italian Royal Beard Contour',
    category: 'beard',
    ...
    client: {
      ...
      location: 'Chawani, Kota',
    },
    concern: 'Uneven, asymmetrical beard growth with undefined cheeklines and neck bushiness.',
    solution: 'Razor line architectural sculpting, eucalyptus hot-towel steam pore opening, and argan hydration conditioning.',
    technique: 'Straight Razor Alignment + Botanical Steam Infusion',
    stylist: 'Rahul Verma (Senior Barber)',
    duration: '35 Mins',
    longevity: '10-14 Days crisp sharpness',
    beforeImg: '/images/gallery-shave.jpg',
    afterImg: '/images/service-beard-sculpting.jpg',
    rating: 5,
    testimonial: 'The razor work by Rahul is razor sharp. The hot towel massage and beard butter treatment left my skin feeling incredible without any razor burns.',
    keyBenefits: ['Sharp Jawline Definition', 'Zero Razor Burn', 'Soft Beard Hydration'],
  },
  {
    id: 'case-skin-detox',
    title: 'Sun-Damaged Tan to Radiant Charcoal Skin Detox',
    category: 'skin',
    categoryLabel: 'Skin & Facial Therapy',
    client: {
      name: 'Aditya Gautam',
      age: 26,
      occupation: 'Faculty Member',
      location: 'Landmark City, Kota',
    },
    concern: 'Heavy sun tan from daily two-wheeler commuting in Kota summer, clogged pores, and dull uneven complexion.',
    solution: 'Multi-stage active charcoal ultrasonic pore cleansing, dead epidermal buffing, and cooling aloe-infused cryo-mask.',
    technique: 'Ultrasonic Extraction + Activated Carbon Detox Mask',
    stylist: 'Sameer Khan (Skin Specialist)',
    duration: '45 Mins',
    longevity: '4-6 Weeks persistent glow',
    beforeImg: '/images/gallery-facial.jpg',
    afterImg: '/images/service-detox-facial.jpg',
    rating: 5,
    testimonial: 'Best facial in Kota hands down. My stubborn tanning and blackheads were completely cleared in one session. The scalp & shoulder massage at the end was pure bliss.',
    keyBenefits: ['Instant Tan Buffing', 'Deep Blackhead Cleansing', 'Cooling Pore Tightening'],
  },
  {
    id: 'case-hair-botox',
...
export const VIDEO_STORIES: VideoStory[] = [
  ...
  },
  {
    ...
    stylist: 'Firoz Khan & Rahul Verma',
