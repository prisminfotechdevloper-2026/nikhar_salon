...
export const CASE_STUDIES: CaseStudy[] = [
  ...
  },
  {
    ...
    stylist: 'Arman (Senior Beard Sculptor)',
    duration: '35 Mins',
    longevity: '10-14 Days crisp sharpness',
    beforeImg: '/images/gallery-shave.jpg',
    afterImg: '/images/gallery-beard-sculpt.jpg',
    rating: 5,
    testimonial: 'The razor work by Arman is razor sharp. The hot towel massage and beard butter treatment left my skin feeling incredible without any razor burns.',
